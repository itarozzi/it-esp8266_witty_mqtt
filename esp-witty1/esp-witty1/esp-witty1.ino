...
Adafruit_MQTT_Publish mqtt_photocell = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/witty/photocell");

// Setup a topic for publishing button.
Adafruit_MQTT_Publish mqtt_button = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/witty/button");


// Setup a feed called 'onoff' for subscribing to changes.
Adafruit_MQTT_Subscribe mqtt_rgb = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/witty/rgb");
...
void loop()
{
  ...
  // Now we can publish stuff, if changed
